...
$(document).ready(function(){
	var DOMAIN="http://localhost/Aakash";
	...
	$("#register_form").on("submit",function(){
		...
		if(!p_patt.test(contact.val())){
			...
			$("#c_error").html("<span class='text-danger'>Please Enter your Valid Contact No:</span>");
			s4=1;
		}else{
					...
					success : function(response){
						...
						//alert(typeof trimmedResponse);
							...
							if(trimmedResponse == 'true'){
								window.location.href="/Aakash/dashboard.php";
...
$("#customer_form").on("submit",function(){
	...
	var p_patt3 = /^\d{9}$/;
		...
		if(!p_patt2.test(customer_contact.val())){
			...
			$("#cc_error1").html("<span class='text-danger'>Please Enter your Valid Mobile No:</span>");
			s3=1;
		...
		if(!p_patt3.test(customer_pan.val())){
			...
			$("#cp_error1").html("<span class='text-danger'>Please Enter your Valid PAN No:</span>");
			s4=1;
